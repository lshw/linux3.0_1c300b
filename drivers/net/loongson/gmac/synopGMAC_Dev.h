...
#define DEFAULT_PHY_BASE PHY3		//We use First Phy 
...
#define TRANSMIT_DESC_SIZE  90	//Tx Descriptors needed in the Descriptor pool/queue
#define RECEIVE_DESC_SIZE   90	//Rx Descriptors needed in the Descriptor pool/queue
...
{
  void * MacBase; 		         /* base address of MAC registers         */
  void * DmaBase;         		 /* base address of DMA registers         */
