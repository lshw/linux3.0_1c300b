...
//sdio_controler
#define LS1C_SDIO_REGS_BASE 0x1fe6c040

#define SDIO_REG(off)       _REG2(KSEG1ADDR(LS1C_SDIO_REGS_BASE),(off))
 ...
 * __initdata.
 */
extern void ls1c_mci_set_platdata(struct ls1c_mci_pdata *pdata);


enum ls1cmci_waitfor {
	COMPLETION_NONE,
	COMPLETION_FINALIZE,
	COMPLETION_CMDSENT,
	COMPLETION_RSPFIN,
...
struct ls1cmci_host {
	...
	enum ls1cmci_waitfor	complete_what;
